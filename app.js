...
function sendemail(email,cinh,cinm){
   ...
   const  sendgrid='PtLAXTvPS4Klw6g_LjQVTw';
  ...
  const msg={
      to: email,
      from: "Shubharil1034.cse19@chitkara.edu.in",
...
function sendexmail(email,couth,coutm){
    const sgMail=require('@sendgrid/mail');
   const  sendgrid='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';
  sgMail.setApiKey(sendgrid);
